...
school = Institution("My University", "myuni.edu")
course = Course("MPCS", 55001, "Algorithms", 3)
school.add_course(course)
offering = CourseOffering(course, 1, 2025, "Fall")
school.add_course_offering(offering)

student = Student("Doe", "John", school, datetime.date(2000,1,1), "jdoe")
school.enroll_student(student)
school.register_student_for_course(student, "Algorithms", "MPCS", 55001, 1, 2025, "Fall")

instructor = Instructor("Smith", "Jane", school, datetime.date(1980,5,5), "jsmith")
school.hire_instructor(instructor)
school.assign_instructor(instructor, "Algorithms", "MPCS", 55001, 1, 2025, "Fall")
